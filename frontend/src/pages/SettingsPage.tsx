...
export function SettingsPage() {
  ...
  if (!electronAPI) return <p className="text-sm text-muted-foreground">Shared onboarding and credentials live in ~/.mr-reviewer. Environment variables still override review defaults.</p>;
